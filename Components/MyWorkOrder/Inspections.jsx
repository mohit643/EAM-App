...
const Inspection = () => {
    ...
    const tasks = [
        {
            id: 1, Activity: 'Undertable functional dem0dotration', ActivityType: 'Saket', WorkCenter: 'Saket', People: '2', Planned: '1.5 H', startDate: '12/09/2023', endDate: 'In-Transit', Duration: '2 hours', StartTime: '2:00 PM', EndTime: '2:30 PM', Actual: '0 H', Remaining: '0,5 H'
        },
        {
                                ...
                                <Card.Content style={{}} >
                                    ...
                                    <View style={{ flexDirection: 'row', }}>
                                        ...
                                        <View style={{ width: 120, }}>
                                            <Text style={styles.cardText}>Inspectoins</Text>
                                            <Text>{item.Activity}</Text>
                                        </View>


                                        <View style={{ width: 100, }}>
                                            <Text style={styles.cardText}>Created on</Text>
